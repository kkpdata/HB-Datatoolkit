...
elseif bovengrens == 1                    % Situatie MET bovengrens
    ...
    for i = 1 : N
        ...
        if strcmp(typeVerdeling, 'normaal')
            ...
            BovenKappa    = PovKappa * (1 - normcdf( vGridTotKappa(i) - kappa, kMu0(end), kSig0(end)));
        ...
        elseif strcmp(typeVerdeling, 'lognormaal')
            ...
            % Bijdrage boven kappa
            BovenKappa    = PovKappa * ( 1 - normcdf( log(vGridTotKappa(i) - kappa -kEps0(end) ), kMuNormaal0(end), kSigNormaal0(end)) );
