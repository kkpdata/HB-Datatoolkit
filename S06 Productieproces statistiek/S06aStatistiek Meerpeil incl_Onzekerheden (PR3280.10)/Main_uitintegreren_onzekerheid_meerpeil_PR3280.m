...
infileVZM        = 'Ovkans_Volkerakzoommeer_piekmeerpeil_v01.txt';
...
switch keuzeStation
    ...
    case 3   % VRM, B = 60 dagen, zie PR1322.30
        OmrekeningKansNaarFreq = 3;
    case 4   % VZM, B = 20 dagen, zie PR1564.14
        OmrekeningKansNaarFreq = 9;
...
%% Check of oude gegevens goed zijn overgenomen in bestanden
...
xlabel('Terugkeertijd [jaar]')
ylabel('Meerpeil [m+NAP]');
legend('Zonder onzekerheid',...
       'Incl. onzekerheid',...
       ['Banden',num2str(100*pCI),'%'],...
       'Hydra-NL incl. onzekerheid PR3280.20',...
       'Hydra-NL banden PR3280.20', 'location', 'NorthWest');
xlim([0.1, 1e7]);
ylim([-0.1, 2.2])
