...
plot(2000*ones(3,1), trekking4_2000,'gv', 'markersize', 10)
...
plot(4000*ones(3,1), trekking4_4000,'gv', 'markersize', 10)
...
plot(6000*ones(3,1), trekking4_6000,'gv', 'markersize', 10)
...
plot(8000*ones(3,1), trekking4_8000,'gv', 'markersize', 10)
...
plot(10000*ones(3,1), trekking4_10000,'gv', 'markersize', 10)
...
plot(12000*ones(3,1), trekking4_12000,'gv', 'markersize', 10)


% ne met 3 <-> 4
plot(14000*ones(3,1), trekking1_14000,'b.', 'markersize', 10)
plot(14000*ones(3,1), trekking2_14000,'r*', 'markersize', 10)
plot(14000*ones(3,1), trekking4_14000,'ko', 'markersize', 10)
plot(14000*ones(3,1), trekking3_14000,'gv', 'markersize', 10)

plot(16000*ones(3,1), trekking1_16000,'b.', 'markersize', 10)
plot(16000*ones(3,1), trekking2_16000,'r*', 'markersize', 10)
plot(16000*ones(3,1), trekking4_16000,'ko', 'markersize', 10)
plot(16000*ones(3,1), trekking3_16000,'gv', 'markersize', 10)

plot(18000*ones(3,1), trekking1_18000,'b.', 'markersize', 10)
plot(18000*ones(3,1), trekking2_18000,'r*', 'markersize', 10)
plot(18000*ones(3,1), trekking4_18000,'ko', 'markersize', 10)
plot(18000*ones(3,1), trekking3_18000,'gv', 'markersize', 10)

plot(20000*ones(3,1), trekking1_20000,'b.', 'markersize', 10)
plot(20000*ones(3,1), trekking2_20000,'r*', 'markersize', 10)
plot(20000*ones(3,1), trekking4_20000,'ko', 'markersize', 10)
plot(20000*ones(3,1), trekking3_20000,'gv', 'markersize', 10)

legend('Variabele X_1','Variabele X_2','Variabele X_3','Variabele X_4') 
