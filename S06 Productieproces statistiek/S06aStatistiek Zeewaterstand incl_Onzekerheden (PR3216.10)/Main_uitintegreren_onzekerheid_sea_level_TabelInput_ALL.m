...
%
% Door: Chris Geerse met aanpassing Karolina
% PR3216.10
% Datum: november 2015.
%
%==========================================================================
...
for r = 1:7 %default 1:7
    ...
    [mMu, mSig] = bepaalOnzekerheidNormaalMaasmond(mGrid);
...
% for r = 1:7
%     
%     vPov_kort(:,r) = interp1(mGrid,vPov(:,r),mInv);   %moet dit niet
%     logaritmisch?
%    
% end
% 
