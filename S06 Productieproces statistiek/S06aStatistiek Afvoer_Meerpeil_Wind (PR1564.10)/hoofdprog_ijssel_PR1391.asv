...
%==========================================================================
drempel = 400;        % variabele voor drempel waarde
...
topduur_inv = ...
    [200, 720;        %eerste kolom moet toenemend zijn, voor tweede geldt dat niet
    800, 24;
    3000, 24]
%parameters afvoer
...
qloblag2(1:2) = -999;
qloblag3 = circshift(qlob,3);   %alleen om een plaatje voor het rapport mee te kaken
qloblag2(1:3) = -999;
...
%==========================================================================
plot_IJsselgolven(golven, ref_niv, B, topduur_inv);
...
ltxt  = char(cltxt);
ttxt  = ['Overschrijdingsfrequentie en data Olst'];
...
xlim([0 2500])
ylim([1e-5 1])
title(['Momentane kansen Olst'])
xlabel('IJsselafvoer Olst, m3/s')
ylabel('momentane overschrijdingskans, [-]')
legend('metingen','volgens formule');
print -depsc -tiff -r300 D:\Users\geerse\Werk\1391_Overzichtsdocument_zoete_wateren\Rapportage\Figuren\fig11.11.eps
