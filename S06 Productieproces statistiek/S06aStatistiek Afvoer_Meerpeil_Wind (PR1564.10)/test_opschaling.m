...
if geldig ==1;
    ...
    for nr = 20:aantal_golven;

        %volgende regel geeft in ieder geval goede resultaten:
        clear piek t_piek DG DG_nieuw golf_orig golf_nieuw index_DG ind piek_aangepast_voor piek_aangepast_na piek_aangepast
        ...
        if fig_golven_verbreed == 1 &nr == 36
            figure
