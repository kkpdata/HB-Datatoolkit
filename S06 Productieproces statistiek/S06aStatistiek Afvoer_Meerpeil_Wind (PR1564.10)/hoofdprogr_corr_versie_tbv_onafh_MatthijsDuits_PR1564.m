...
sinv = [0, 100];     %linksboven moet beginnen met x = 0; altijd minimaal 1 rij opgeven.
...
plot(i, d2,'r');
plot(i, d3,'r');
xlabel('IJsselafvoer [m^3/s]')
ylabel('IJsselmeerpeil [m+NAP]')
title(['Correlatie tussen IJsselafvoer en IJsselmeerpeil bij \sigma =', sprintf('%3.1d',sinv(1,2))])
