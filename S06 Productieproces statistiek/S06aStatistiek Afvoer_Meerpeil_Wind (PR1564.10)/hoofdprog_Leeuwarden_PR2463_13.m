%==========================================================================
% Hoofdprogramma Leeuwarden
% Door: Chris Geerse

%  Quick and dirty aanpassing van "hoofdprog_Schiphol_01.m".
...
[jaar, maand, dag ,uur,r,qdd,snelheid,qup] = textread('s270.txt','%u %u %u %u %u %u %u %u','delimiter',',','headerlines',22);
