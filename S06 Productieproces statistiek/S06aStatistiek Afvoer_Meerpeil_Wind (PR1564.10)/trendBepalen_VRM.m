...
%bepalen maximum, gemiddelde en minimum voor elk whjaar
...
ltxt  = char(cltxt);
ttxt  = 'Trends Veluwe Randmeer: regressielijnen';
xtxt  = 'whjaren';
ytxt  = 'meerpeil, m+NAP';
Xtick = 1950:5:2005;
Ytick = -0.6:0.2:0.6;
...
cltxt  = {'maxima','gemiddelde','minima'};
ltxt  = char(cltxt);
ttxt  = 'Trends Veluwe Randmeer: lopende gemiddeldes (5-jaarlijks)';
xtxt  = 'whjaren';
ytxt  = 'meerpeil, m+NAP';
Xtick = 1950:5:2005;
Ytick = -0.6:0.2:.6;
