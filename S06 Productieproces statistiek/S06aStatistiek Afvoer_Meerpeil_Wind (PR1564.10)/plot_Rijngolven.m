function [] = plot_Rijngolven(golven, ref_niv, B, topduur_inv);
%
...
%topduur_inv geeft invoergegevens topduur (n*2, k1 = afvoerniveaus, k2 =
%bijbehorende topduren
%
%Output:
%plaatjes
%==========================================================================
...
% print -depsc -tiff -r300 P:\Pr\2065.10\Rapportage\Figuren\fig_subplots_Rhine
