function [] = plot_Vechtgolven_incltrapezium_top2dagen(golven);
%
...
%==========================================================================
%
% Plaatjes worden gemaakt van de geselecteerde golven versus trapezia met
% topduur 2 dagen.
%
%Input:
%
...
for n = 1:aantal_golven
    ...
    plot([-15, -1, 1, 15], [0, golven(n).piek, golven(n).piek, 0], 'r')
