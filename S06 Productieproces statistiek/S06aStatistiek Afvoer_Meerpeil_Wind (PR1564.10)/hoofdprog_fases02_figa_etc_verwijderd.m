...
padnaam_uit = 'c:/Matlab/Vecht_IJs_IJsm_Sch_VRM_Rijn_Maas/';
...
zpotI = 7;     %zichtduur voor selectie onafhankelijke pieken (piek op t is max op [t-zpotI, t+zpotI]).
zBI = 7;       %halve breedte van geselecteerde tijdreeks (default=zpotI). NB zBI>zpotI
%kan soms crash geven bij aanpassing van golven tbv
%opschaling.
zD = 7;        %bij gegeven piek op tijd t wordt gezocht naar max van andere variabele in [t-zD,t+zD]
%default zD = zpotI
...
elseif geval == 2 %I = Vecht, D = IJsm  (Vechtreeks bevat grote hiaten)
    drempelI = 50;  %127.99 -> 28 puntenparen, 128 -> 25 paren
...
%==========================================================================
%verschil als functie van piekmeerpeil
%==========================================================================
...
%==========================================================================
%Tbv Waquarelatie tussen Vecht en IJssel
%==========================================================================
...
%==========================================================================
%Illustratie van faseverschil tussen twee trapezia
%==========================================================================
