...
ltxt = [];
ttxt  = ['Overschrijdingsfrequentie en data IJsselmeer'];
...
xlim([-.50 0.8])
ylim([1e-5 1])
title(['Momentane kansen IJsselmeer'])
xlabel('meerpeil, m+NAP')
ylabel('momentane overschrijdingskans, [-]')
legend('metingen','volgens formule');
%print -depsc -tiff -r300 D:\Users\geerse\Werk\1391_Overzichtsdocument_zoete_wateren\Rapportage\Figuren\fig11.14.eps
