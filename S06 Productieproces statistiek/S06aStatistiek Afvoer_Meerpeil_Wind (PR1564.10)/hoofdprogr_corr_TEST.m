...
% %invoeren verloop van s in getransformeerde ruimte, (x, s(x)). 
sinv = [0, 6    %linksboven moet beginnen met x = 0; altijd minimaal 1 rij opgeven.
30, 6]          %getal rechtsonder wordt ook voor hogere x aangenomen als constante
