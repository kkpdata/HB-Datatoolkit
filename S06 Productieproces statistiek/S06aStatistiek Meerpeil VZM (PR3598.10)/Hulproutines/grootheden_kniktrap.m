...
% Wegschrijven informatie over effect normeren kansvectoren
disp(' ')
disp(sprintf('sum(fy_piek*stapy) voor normeren = %6.5f',sum(fy_piek*stapy)))
disp(sprintf('Gy_piek(1) voor normeren         = %6.5f',Gy_piek(1)))
disp('Als een of meer van deze getallen duideluk afwijkt van 1, is de berekening onnauwkeurig!')
...
% Wegschrijven informatie over effect normeren kansvectoren
disp(' ')
disp(sprintf('sum(fx*stapy) voor normeren  = %6.5f',sum(fx*stapy)))
disp(sprintf('Gx(1) voor normeren          = %6.5f',Gx(1)))
disp('Als een of meer van deze getallen duideluk afwijkt van 1, is de berekening onnauwkeurig!')
disp(' ')
