%==========================================================================
% Scrpt voor snelle analyse Rak Noord
%
% Door: Chris Geerse
% PR3598.10
% Datum: mei 2017.
...
legend(['Data (gemanipuleerd)', num2str(bej),' tm ',num2str(eij),' winterhalfjaren'],...
