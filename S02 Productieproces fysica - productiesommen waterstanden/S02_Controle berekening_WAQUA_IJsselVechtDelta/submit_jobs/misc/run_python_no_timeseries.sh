...
echo python physical_checks_ijvd_tab_only.py ${RUNID} ${RUNID} ../hr2017_wda/input_generalparameters.ini $plot_timeseries
     python physical_checks_ijvd_tab_only.py ${RUNID} ${RUNID} ../hr2017_wda/input_generalparameters.ini $plot_timeseries
