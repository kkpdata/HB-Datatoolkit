function GenerateSettingsMatFiles_BER_sep(IDsFile, matFileDir)
...
for iWaterSystem = 1:numel(WaterSystem)
    ...
    timeIntegration.MHW     = [3 1 3 3];
    timeIntegration.QVar    = [1 1 3 3];
    timeIntegration.Waves   = [3 1 3 3];
    timeIntegration.HBN     = [3 1 3 3];
    timeIntegration.KW      = [3 1 3 3];
    timeIntegration.KW_FBC  = [1 1 1 1];
    
    probMethod.MHW      = [11 12 11 11];
    probMethod.QVar     = [4  4  4 4];
    probMethod.Waves    = [11 12 11 11];
    probMethod.HBN      = [11 12 11 11];
